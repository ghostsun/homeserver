...
public class PMS5003Util {
		...
		try {
			...
			if (commPort instanceof SerialPort) {
				...
				try {
					...
					throw new Exception("SerialPortParameterFailure");
				}
			...
			throw new Exception("NoSuchPort");
		} catch (PortInUseException e2) {
			throw new Exception("PortInUse");
		}
	}
	...
	public static void sendToPort(SerialPort serialPort, byte[] order) throws Exception {
		...
		try {
			...
			throw new Exception("SendDataToSerialPortFailure");
		} finally {
			try {
				if (out != null) {
					out.close();
				...
				throw new Exception("SerialPortOutputStreamCloseFailure");
			}
		}
	...
	public static byte[] readFromPort(SerialPort serialPort) throws Exception {
		...
		try {
			...
			throw new Exception("ReadDataFromSerialPortFailure");
		} finally {
			try {
				if (in != null) {
					in.close();
				...
				throw new Exception("SerialPortInputStreamCloseFailure");
			}
	...
	public static void addListener(SerialPort port, SerialPortEventListener listener) throws Exception {
		...
		try {
			...
			throw new Exception("TooManyListeners");
		}
	}
